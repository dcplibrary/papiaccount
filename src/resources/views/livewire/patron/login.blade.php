<flux:main container class="flex items-center justify-center min-h-screen px-4">
    <flux:card class="bg-white p-6 shadow-lg outline outline-black/5 dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10 max-w-md w-full">
        <div class="mx-10">
            <x-papiaccount::logo />
