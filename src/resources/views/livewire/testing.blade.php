<div>
    <flux:sidebar sticky collapsible="mobile" class=" flex-1 bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700 ">
        <flux:sidebar.header>
            <flux:sidebar.brand
                href="#"
    ...
    <flux:header class="lg:hidden flex-1">
    ...
    <flux:main container class="max-w-xl lg:max-w-3xl flex-1">
